...
class Units_factory {
    constructor(game) {
        ...
        this.baseUnitBlueprint = {
            ...
            baseDamages         : [10       ,1.046   ],
            power               : [10       ,1.046   ],
            
            defense             : [4        ,1.046   ],
            resistance          : [2        ,1.046   ],
            
            //contactPrecision  : depend of dodge (dodge + 85)
            //distancePrecision : depend of contact precision (Contactprecision - 30)
        ...
        this.modulatorsTable = {
            ...
            baseDamages         : [0.7    ,0.75   ,0.8    ,0.85   ,0.9    ,1      ,1.1    ,1.2    ,1.3    ,1.4    ,1.5    ],
            ...
            contactPrecision    : [-25    ,-20    ,-15    ,-10    ,-5     ,0      ,+5     ,+10    ,+15    ,+20    ,+25    ],
    ...
    buildNewUnit(id, team, archetype, rank, level, weaponId) {
        ...
        let weapon = modulators.weapons[weaponId - 1];
        ...
        if (rankedLevel > 1) {
            ...
            prototypeStats.baseDamages                                          = Math.round((base.baseDamages[0] * (base.baseDamages[1] ** (rankedLevel - 1))) * modulatorsTable.baseDamages[5 + modulators.baseDamages[0]]);
            ...
            prototypeStats.contactPrecision                                     = Math.round((base.speed[0] * (base.speed[1] ** (rankedLevel - 1))) + modulatorsTable.contactPrecision[5 + modulators.contactPrecision[0]]);
            ...
            prototypeStats.baseDamages                                          = Math.round(base.baseDamages[0] * modulatorsTable.baseDamages[5 + modulators.baseDamages[0]]);
            ...
            prototypeStats.contactPrecision                                     = Math.round(base.speed[0] + modulatorsTable.contactPrecision[5 + modulators.contactPrecision[0]]);
        ...
        let unit = new Unit(id, team, codeName, name, weapon, prototypeStats);
